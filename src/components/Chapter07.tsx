  ...
  <section id="cap07" className="section-light py-20 md:py-28">
    <div className="max-w-3xl mx-auto px-6 relative">
      ...
      <ScrollReveal delay={0.2}>
        <blockquote className="border-l-4 border-primary pl-6 py-4 my-10 bg-primary/5 rounded-r-lg">
          <p className="text-foreground/90 text-lg md:text-xl italic font-display leading-relaxed">
            ...
            Ele compete com ela ao seu lado."
          </p>
        </blockquote>
      </ScrollReveal>
      ...
      <ScrollReveal delay={0.3}>
        <p className="text-foreground/80 text-base md:text-lg leading-relaxed mb-6">
          A Crissair acredita nesse futuro. Há mais de 33 anos, estamos ao lado dos arquitetos e designers que projetam os ambientes mais sofisticados do Brasil. Nossos eletrodomésticos estão presentes nas cozinhas que você cria, nos projetos que você assina, nas experiências que você proporciona aos seus clientes.
        </p>
      </ScrollReveal>
